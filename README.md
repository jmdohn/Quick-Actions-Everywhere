...
[13,950+ points and counting](https://success.salesforce.com/ideaView?id=0873A0000003TXFQA2)
=======
[Background][Background]
[Installation][Installation]
[Parameters][Parameters]
...
Because I've migrated to lightning and because your action bar can quickly get overloaded, I wanted to find a solution and keep context for end users to operate within their related lists.  Given that Lightning Out allows for buttons to exist in classic and Lightning, this was the solution for me.  I know I'm not alone and there is an idea with a sizable amount of points to it [here - 13,950+ points and counting](https://success.salesforce.com/ideaView?id=0873A0000003TXFQA2).
>>>>>>> 460c095... Initial commit Quick-Actions-Everywhere
...
<<<<<<< HEAD
	![Auth Provider](../master/images/AuthProvider.JPG)
=======
	![Auth Provider](../images/AuthProvider.png?raw=true)
>>>>>>> 460c095... Initial commit Quick-Actions-Everywhere
...
6. Ensure that the Named Credential qae REST API has the correct instance url.  You will need to click on "Edit" on the named credential and authenticate as the named principal user that should run the REST callout - this means all callouts will run as this user.  It is highly recommended that this is a service user to monitor ussage.
	![Named Credential](../master/images/Named_Credential.JPG)
=======
	![Connected App](../images/ConnectedApp.png?raw=true)
3. Copy the Consumer Key and the Consumer Secret from the connected app into the qae_REST_API auth provider screen.
	![Connected App Key and Secret](../images/ConnectedApp2.png?raw=true)
4. Save the auth provider.
5. Get the callback URL from the Auth Provider and copy to the callback url of the connected application.
6. Ensure that the Named Credential qae REST API has the correct instance url.  You will need to click on "Edit" on the named credential and authenticate as the named principal user that should run the REST callout - this means all callouts will run as this user.  It is highly recommended that this is a service user to monitor ussage.
	![Named Credential](../images/Named_Credential.png?raw=true)
>>>>>>> 460c095... Initial commit Quick-Actions-Everywhere
